...
function initializeDatabase(database) {
  ...
  if (adminCount.count === 0) {
    ...
    database.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?)
    `).run('Azad Ansari', 'admin', '7208434724', 'admin@gmail.com', hashedPassword);
    ...
    insertBooking.run('901408998', 'Lavanaya Singh', 'Aruna Singhaniya', '7208434724', '2024-02-29', '15:33', 1, 'P-816 Kanvya Nagar Geetanjali Apt', 'Lucknow', 'UP', 'Arrange BLS ambulance with gynoclogist', 'Patient Pick from given address', 'Pickup', 'DL14RT5678');
    ...
    insertPage.run('contactus', 'Contact Us', '#890 KFG Apartment, Gauri Kunj, Delhi-India.', 'test@gmail.com', '7208434724');
  }
}
