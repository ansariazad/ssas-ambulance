...
async function seedData() {
    ...
    await supabase.from('admins').upsert({
        admin_name: 'Admin', username: 'admin', mobile_number: '8989898980',
    ...
    const pages = [
        ...
        { page_type: 'contactus', page_title: 'Contact Us', page_description: '#890 KFG Apartment, Gauri Kunj, Delhi-India.', email: 'test@gmail.com', mobile_number: '7894561236' },
    ];
